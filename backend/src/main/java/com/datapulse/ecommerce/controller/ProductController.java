...
public class ProductController {
    ...
    @PostMapping("/my-store") @Operation(summary="Create product for own store") public ResponseEntity<ApiResponse<ProductResponse>> createForMyStore(@Valid @RequestBody ProductRequest req, @AuthenticationPrincipal UserPrincipal principal) { return ResponseEntity.ok(ApiResponse.success("Created",productService.createProductForStore(req, principal.getId()))); }
